 ...
 * Version: 7.2 (Standalone, Robust, and Corrected)
 * Описание: Этот скрипт полностью автономен. Он сам ждет загрузки страницы,
 * проверяет наличие Chart.js и запускает всю логику калькулятора.
 */
